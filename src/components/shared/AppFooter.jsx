						...
						<ul className="flex gap-4 sm:gap-8">
							{socialLinks.map((link) => (
								<a
									...
									target="__blank"
									key={link.id}
									className="text-opacity-50 text-ternary-dark hover:opacity-20 dark:text-gray-400 cursor-pointer rounded-lg bg-primary-light dark:bg-ternary-dark hover:dark:bg-gray-100 shadow-sm p-4"
								>
									<i className="text-xl sm:text-2xl hover:opacity-20">
										{link.icon}
									</i>
								</a>
							))}
